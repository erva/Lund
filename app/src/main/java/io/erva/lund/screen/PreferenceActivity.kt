...
class PreferenceActivity : AppCompatActivity() {
    ...
    override fun onResume() {
        ...
        if (isNotificationRequested) {
            bankModels.firstOrNull { it.source == SOURCE.NOTIFICATION }?.let {
    ...
    private fun isSmsPermissionGranted(): Boolean {
        return ContextCompat.checkSelfPermission(this@PreferenceActivity,
                                                 Manifest.permission.READ_SMS) == PackageManager.PERMISSION_GRANTED &&
                ContextCompat.checkSelfPermission(this@PreferenceActivity,
    ...
    private fun requestReadAndSendSmsPermission(requestCode: Int) {
        ActivityCompat.requestPermissions(this, arrayOf(Manifest.permission.READ_SMS, Manifest.permission.RECEIVE_SMS),
                                          requestCode)
    }
    ...
    private fun isNotificationAccessGranted(): Boolean {
        return NotificationManagerCompat.getEnabledListenerPackages(application).contains(packageName)
    }
